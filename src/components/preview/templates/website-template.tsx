...
<nav style="max-width: 1280px; margin: 0 auto; padding: 1.25rem 1.5rem; display: flex; justify-content: space-between; align-items: center;">
  ...
  <div id="nav-links" style="display: flex; gap: 2rem; align-items: center;">
    ...
    <small style="cursor: pointer;">Docs</small>
...
<section id="hero" style="max-width: 1280px; margin: 0 auto; padding: 4rem 1.5rem 5rem; display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
  <div>
    ...
    <p style="margin: 0 0 2rem; max-width: 440px;">Create harmonious type scales, preview them in real layouts, and export production-ready CSS &mdash; all in one place.</p>
  ...
  <div id="features-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1.5rem;">
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
        <small style="font-weight: 700;">Aa</small>
      </div>
      <h4 style="margin: 0 0 0.5rem;">Per-Element Control</h4>
      <p><small>Override font weight, line height, and letter spacing for each individual element in your type scale.</small></p>
    </div>
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
        <small style="font-weight: 700;">50+</small>
      </div>
      <h4 style="margin: 0 0 0.5rem;">Scale Ratios</h4>
      <p><small>Choose from over 50 musical and mathematical ratios, or define your own custom scale factor.</small></p>
    </div>
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
      ...
      <p><small>Copy clean CSS custom properties, Tailwind config, or push tokens directly to Figma as variables.</small></p>
    </div>
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
        <small style="font-weight: 700;">Rr</small>
      </div>
      <h4 style="margin: 0 0 0.5rem;">Live Preview</h4>
      <p><small>See typography come alive in real-world templates -- websites, dashboards, and blog layouts.</small></p>
    </div>
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
        <small style="font-weight: 700;">px</small>
      </div>
      <h4 style="margin: 0 0 0.5rem;">Fluid Typography</h4>
      <p><small>Generate fluid clamp() values that smoothly interpolate sizes between mobile and desktop breakpoints.</small></p>
    </div>
    <div style="border: ${border}; border-radius: 12px; padding: 1.75rem;">
      <div style="width: 40px; height: 40px; border-radius: 10px; background: color-mix(in srgb, currentColor 8%, transparent); margin-bottom: 1rem; display: flex; align-items: center; justify-content: center;">
        <small style="font-weight: 700;">G</small>
      </div>
      <h4 style="margin: 0 0 0.5rem;">Google Fonts</h4>
      <p><small>Browse and preview any Google Font with instant pairing suggestions and weight recommendations.</small></p>
    </div>
  </div>
</section>
...
<section id="split-1" style="max-width: 1280px; margin: 0 auto; padding: 0 1.5rem 5rem; display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center;">
  ...
  <div>
    ...
    <p style="margin: 0 0 1.5rem;">Go beyond global settings. Adjust font weight, line height, letter spacing, and text transform for each heading level independently. Your h1 can be tight and bold while your h4 stays light and airy.</p>
...
<section style="max-width: 1280px; margin: 0 auto; padding: 3rem 1.5rem 4rem; border-top: ${borderLight}; border-bottom: ${borderLight};">
  <div id="stats-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 2rem; text-align: center;">
    <div>
      ...
      <small>Scale Ratios</small>
    </div>
    <div>
      <h2 style="margin: 0 0 0.25rem;">1000+</h2>
      <small>Font Pairings</small>
    </div>
    <div>
...
<section style="max-width: 1280px; margin: 0 auto; padding: 0 1.5rem 5rem;">
  ...
  <div id="hiw-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;">
    <div style="text-align: center; padding: 0 1rem;">
      ...
      <p><small>Pick a base size and ratio. Start with a preset like Minor Third or Perfect Fourth, or go custom.</small></p>
    </div>
    <div style="text-align: center; padding: 0 1rem;">
      <div style="width: 48px; height: 48px; border-radius: 50%; border: ${border}; margin: 0 auto 1.25rem; display: flex; align-items: center; justify-content: center;">
      ...
      <p><small>Fine-tune weight, spacing, and line height for each heading level. Preview changes in real time.</small></p>
    </div>
    <div style="text-align: center; padding: 0 1rem;">
      <div style="width: 48px; height: 48px; border-radius: 50%; border: ${border}; margin: 0 auto 1.25rem; display: flex; align-items: center; justify-content: center;">
      ...
      <p><small>Copy CSS custom properties, grab Tailwind config, or sync directly to Figma as design tokens.</small></p>
    </div>
  </div>
</section>
